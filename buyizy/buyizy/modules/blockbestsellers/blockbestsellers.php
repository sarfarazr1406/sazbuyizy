...
class BlockBestSellers extends Module
{
	...
	public function hookdisplayHomeTabContent($params)
	{
		...
		{
		    $combinations = $this->getProductAttributeCombinations(BlockBestSellers::$cache_best_sellers);
			$specificprice=$this->getProductSpecificPrice(BlockBestSellers::$cache_best_sellers);
