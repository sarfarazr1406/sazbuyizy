...
class BlockNewProducts extends Module
{
	...
	public function hookdisplayHomeTabContent($params)
	{
		...
		{
			$combinations = $this->getProductAttributeCombinations(BlockNewProducts::$cache_new_products);
			$specificprice=$this->getProductSpecificPrice(BlockNewProducts::$cache_new_products);
