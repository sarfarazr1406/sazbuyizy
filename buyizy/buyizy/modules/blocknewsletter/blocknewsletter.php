...
class Blocknewsletter extends Module
{
	...
	public function confirmEmail($token)
	{
		...
		return $this->l('Thank you for subscribing for our promotional offers.');
	}
	...
	{
		return Mail::Send($this->context->language->id, 'newsletter_conf', Mail::l('Subscription complete', $this->context->language->id), array(), pSQL($email), null, null, null, null, null, dirname(__FILE__).'/mails/', false, $this->context->shop->id);
	}
