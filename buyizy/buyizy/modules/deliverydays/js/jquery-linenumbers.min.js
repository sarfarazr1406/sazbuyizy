...
(function($){
	$.fn.linenumbers = function(in_opts){
		...
		return this.each(function(){
			...
			$(this)
				.wrap('<div style="width:'+$(this).css('width')+';"></div>')
				.before('<textarea style="width:'+new_textarea_width+';float:left;padding-left:0;margin-right:'+'-'+new_textarea_width+';font-family:monospace;white-space:pre;overflow:hidden;" disabled="disabled"></textarea>')
			...
			$(this).bind('mouseup mousemove',function(){
