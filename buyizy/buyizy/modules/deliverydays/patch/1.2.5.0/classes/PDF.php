...
/**
  ...
  * @license http://opensource.org/licenses/afl-3.0.php  Academic Free License (AFL 3.0)http://opensource.org/licenses/afl-3.0.php  Academic Free License (AFL 3.0)
  * @version 1.2
  *
  */
	...
	public static function invoice($order, $mode = 'D', $multiple = false, &$pdf = NULL, $slip = false, $delivery = false)
	{
		...
		/* start deliverydays */
			if (
				...
				($module->active) &&
				($deliveryDay = $module->getDate($order->id_cart, false))
			) {
