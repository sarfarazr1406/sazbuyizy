			...
			{foreach from=$languages item=language}
				...
				{/if}
					<div class="col-lg-6">
						...
						<img src="{$image_baseurl}{$fields[0]['form']['images'][$language.id_lang]|escape:'html':'UTF-8'}" class="img-thumbnail" />
						{/if}
						...
						<div class="dummyfile input-group">
							...
							<span class="input-group-btn">
								<button id="{$input.name}_{$language.id_lang}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
									<i class="icon-folder-open"></i> {l s='Choose a file' mod='tmsubbanner'}
								</button>
							</span>
						</div>
					</div>
