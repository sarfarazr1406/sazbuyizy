		...
		{foreach from=$ordered_adr_fields item=field_name}
			...
			{if $field_name eq 'city'}
				<div class="required form-group">
					...
					<input class="is_required validate form-control" data-validate="{$address_validation.$field_name.validate}" type="text" name="city" id="city" value="Pune" maxlength="64" readonly />
				</div>
