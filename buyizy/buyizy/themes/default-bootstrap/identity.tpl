        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
                ...
                {if $newsletter}
                    <div class="checkbox">
                        <label for="newsletter">
                            ...
                            {l s='Subscribe for our promotional mails now.'}
                        </label>
                    </div>
                    <!--<div class="checkbox">
                        <label for="optin">
			...
			{/if}
                ...
                <p id="security_informations" class="text-right">
                    <i><a href="{$link->getCMSLink('6')}">{l s='*Please go through our privacy policy about our personal information sharing policy.'}</a></i>
                </p>
            </fieldset>
        </form> <!-- .std -->
    {/if}
