...
{/if}
	<div class="shopping_cart">
		...
		{if !$PS_CATALOG_MODE}
		{*assign var='blockcart_cart_flag' value='Cart::BOTH_WITHOUT_SHIPPING'|constant*}
		{*assign var='left_over_amt' value=399 - $cart->getOrderTotal(false, $blockcart_cart_flag)*}
			<div class="cart_block block exclusive">
				<div class="block_content">
					...
					{*if $left_over_amt > 0}
					    <span id="free_delivery_msg" style="padding:4px;display:none">Order for <span id="left_amount">{convertPrice price = $left_over_amt}</span> more to avail free delivery</span>
					{/if*}
					{if $product.cart_quantity >=3}<div class="scrollit">{/if}
						{if $products}
							<dl class="products {if $products|@count > 2} scrollit{/if}">
						...
						{/if}
						{if $product.cart_quantity >=3}</div>{/if}
		...
		<div class="clearfix_popup">
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				...
				<div class="layer_cart_row">
					<strong class="dark">
						{l s='Total products\' price' mod='blockcart'}
