...
{if $products}
    {if !$refresh}
		...
		<p class="shop_list">
			<a href="{$link->getModuleLink('blockwishlist', 'view', ['token' => $token_wish])|escape:'html':'UTF-8'}"
                    class="button btn btn-default newshoplist"
                    title="{l s='Go to the shopping page' mod='blockwishlist'}"
                    rel="nofollow">
                    <span>{l s='Shop your list' mod='blockwishlist'}</span>
            </a>
		</p>
    {/if}
