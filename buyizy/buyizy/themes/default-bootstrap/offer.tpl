...
<style>
header { width: 100%; display: table; background-color:white; min-height: 50px;
	text-align: center;}
body{
	overflow:auto;
	margin-top: 0px;
...
<body>
<div id="wrapper">
<div id="callout"><p>Call now to order: <b>9769616815</b></p></div>
<header>
<div id="logo"><a href= "http://www.buyizy.com"><img src="img/images/Logo-Original200x100.png" /></a></div>
<div id="social">
<ul>
            <li><a href= "https://www.facebook.com/pages/Buyizycom/195273547313120"><img src="img/images/facebook-icon.png" alt="" /></a></li>
            <li><a href= "https://twitter.com/Buyizy"><img src="img/images/twitter-icon.png" alt="" /></a></li>
            <li><a href= "https://plus.google.com/102969298846870717899"><img src="img/images/gplus-icon.png" alt="" /></a></li>
          </ul></div>
</header>
<script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
    ...
    <div id="slider1_container" style="position: relative; margin: 0 auto;
        top: 0px; left: 0px; right:0px; width: 1300px; height: 500px; overflow: hidden;">
        <!-- Loading Screen -->
...
<!--<div class="section">
<h5>#SHOPPING</h5>
<img alt="" src="img/images/banner-1.jpg"/>
<p>best offer for new users </p>
</div>
<div class="section">
<h5>#LIFEGOEASY</h5>
<img alt="" src="img/images/banner-2.jpg"/>
<p>best offer for new users </p>
</div>
<div class="section">
<h5>#HAPPINESS</h5>
<img alt="" src="img/images/banner-3.jpg"/>
<p>best offer for new users </p>
</div>-->
<footer>
<div align="center"><b>buyizy.com</b></div>
<!--  <div class="section">
<h3>OFFER ONE</h3>
<p>best offer for new users </p>
</div>
