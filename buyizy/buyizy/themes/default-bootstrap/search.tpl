...
{if !$nbProducts}
	<p class="alert alert-warning">
		{if isset($search_query) && $search_query}
			{l s='Did not find what you were searching for? Suggest us the product at suggestions@buyizy.com and we will make sure it is available next time you land on our website. Or call on 9769616815 for more assistance on what you are looking for.'}&nbsp;
